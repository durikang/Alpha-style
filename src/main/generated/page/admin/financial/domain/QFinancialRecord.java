...
public class QFinancialRecord extends EntityPathBase<FinancialRecord> {
    ...
    private static final long serialVersionUID = -1319832845L;
    ...
    public final page.admin.item.domain.QItem item;
    ...
    public QFinancialRecord(Class<? extends FinancialRecord> type, PathMetadata metadata, PathInits inits) {
        ...
        this.item = inits.isInitialized("item") ? new page.admin.item.domain.QItem(forProperty("item"), inits.get("item")) : null;
